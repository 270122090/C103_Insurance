...
//        cout << "Monthly Repayment will be $ " << p1total;
//    }
//    if (num == 2)
//    {
//        placeCursor(screen, 25, 5);
...
//        cout << "Policy # 2 : " << pc[0];
//        placeCursor(screen, 28, 5);
//        cout << "Monthly Repayment will be $ " << p2total;
//        placeCursor(screen, 29, 5);
//        cout << "Multi-policy Discount " << clients.pdiscount;
...
void weeklyRenew()
{
    ...
    while (!clientform.eof())
    {
        ...
        if ((strcmp(startDate, record4.sdate) == 0) && (strcmp(prevHolder, record4.renew) == 0))
        {
            ...
            placeCursor(screen, 27, 10);
            cout << "Record holder registrations: " << record4.rego1 << " " << record4.rego2;

            placeCursor(screen, 29, 10);
            cout << "Record holder policies: " << record4.p1 << " " << record4.p2;
...
void weeklyRegi()
{
    ...
    while (!clientform.eof())
    {
        ...
        if ((strcmp(startDate, record3.sdate) == 0) && (strcmp(prevHolder, record3.renew) == 0))
        {
            ...
            placeCursor(screen, 30, 10);
            cout << "Record holder registrations" << record3.rego1 << " " << record3.rego2;

            placeCursor(screen, 32, 10);
            cout << "Record holder policies" << record3.p1 << " " << record3.p2;
